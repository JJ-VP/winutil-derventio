            ...
            <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                <Grid Background="Transparent" >
                    ...
                    <StackPanel Background="{MainBackgroundColor}" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Left" VerticalAlignment="Top" Grid.Column="0" Grid.ColumnSpan="3" Margin="5">
                        ...
                        <Button Name="WPFDerventio" Content=" Derventio Essentials" Margin="2"/>
                    </StackPanel>
...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallmicrosoftOffice" Content="Office 365" ToolTip="Microsoft Office 365." Margin="0,0,2,0"/><TextBlock Name="WPFInstallmicrosoftOfficeLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://musescore.org/en" />
</StackPanel>
<StackPanel Orientation="Horizontal">
...
<Button Name="WPFInstallKaspersky" Content="Install Kaspersky" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
<Button Name="WPFInstallDiscoveryAgent" Content="Install FreshService Agent" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
<Button Name="WPFInstallVPN" Content="Install VPN" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
<Button Name="WPFInstallSettings" Content="Derventio Settings" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
