                ...
                <Grid Background="Transparent" >
                    ...
                    <Border Grid.Row="1" Grid.Column="1">
                        <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
                            ...
                            <StackPanel Orientation="Horizontal">
                                <CheckBox Name="WPFInstallmicrosoftOffice" Content="Office 365" ToolTip="Microsoft Office 365." Margin="0,0,2,0"/>
                                <TextBlock Name="WPFInstallmicrosoftOfficeLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://musescore.org/en"/>
                            </StackPanel>
                            <StackPanel Orientation="Horizontal">
